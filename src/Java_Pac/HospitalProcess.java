...
DisplayPatientDetails s= new DisplayPatientDetails();
SimpleDateFormat formatter= new SimpleDateFormat("yyyy/MMM/dd HH:mm:ss");
joindate = formatter.format(currentDate.getTime());
Patient p1 = new Patient(1,"srilekha", "Miyapur,Hyderabad", 40, 'm', "Fever", 250f, joindate);
arl.add(p1);
Patient p2 = new Patient(2,"Raja", "Madhapur,Hyderabad", 45, 'f',   "Cough", 250f, joindate);
arl.add(p2);
Patient p3 = new Patient(3,"kavya", "Hydernagar,Hyderabad", 56, 'm', "Cancer", 250f, joindate);
arl.add(p3);
do
{
Patient p = new Patient();
System.out.println("Choose the below any one option \n 1 to register a Patient \n 2 to update Patient details \n 3 to deactivate Patient details \n 4 to display Patient details");
...
System.out.println("Enter Patient Sex: F or M");
...
// inheritance concept
 class DisplayPatientDetails extends Patient
{
	 HospitalProcess hm = new HospitalProcess();
